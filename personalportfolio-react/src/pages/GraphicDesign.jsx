...
const GraphicDesign = () => {
  ...
  const graphicProjects = portfolioItems.filter(
    (item) => item.category === "Graphic Design"
  );

  return (
    <section id="graphic-design" className="inner portfolio">
      ...
      <div className="content__block block-large">
        ...
        <h2 className="h2__title animate-in-up">
          Visual Design & Creative Work
        </h2>
        <p className="h2__text animate-in-up">
          Explore my graphic design portfolio featuring posters, branding,
          illustrations, and visual content created for various clients and
          projects.
        </p>
      </div>
