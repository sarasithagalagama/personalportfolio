...
const FreelanceProjects = () => {
  ...
  const freelanceProjects = portfolioItems.filter(
    (item) => item.category === "Freelance Projects"
  );

  return (
    <section id="freelance-projects" className="inner portfolio">
      ...
      <div className="content__block block-large">
        ...
        <h2 className="h2__title animate-in-up">Client Work & Commissions</h2>
        <p className="h2__text animate-in-up">
          Explore my freelance portfolio featuring diverse client projects,
          custom solutions, and creative collaborations from Fiverr and beyond.
        </p>
      </div>
