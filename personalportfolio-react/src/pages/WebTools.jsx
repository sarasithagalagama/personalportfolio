...
const WebTools = () => {
  ...
  const webToolsProjects = portfolioItems.filter(
    (item) => item.category === "Web Tools"
  );

  return (
    <section id="web-tools" className="inner portfolio">
      ...
      <div className="content__block block-large">
        ...
        <h2 className="h2__title animate-in-up">Utilities & Developer Tools</h2>
        <p className="h2__text animate-in-up">
          Explore my collection of web-based tools and utilities designed to
          solve specific problems and improve productivity.
        </p>
      </div>
